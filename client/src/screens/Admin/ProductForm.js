...
export default function ProductForm(props) {
  ...
  const addProduct = () => {
    if (
      ...
      setError("Pleasy fill in the form correctly");
    }
    ...
    <FormContainer title="Add Product">
      <View style={styles.imageContainer}>
        ...
        <TouchableOpacity style={styles.imagePicker} onPress={pickImage}>
          <Icon style={{ color: "white" }} name="camera" size={24} />
        </TouchableOpacity>
      </View>
      ...
      />
      <Item picker>
        <Text style={{ color: "red", fontSize: 16 }}>Selected category:</Text>
        <Picker
          mode="dropdown"
          iosIcon={<Icon color="black" name="arrow-down" size={30} />}
          style={{ width: undefined, height: 50 }}
          selectedValue={pickerValue}
          onValueChange={(i) => [setPickerValue(i), setCategory(i)]}
        >
          {categories.map((c) => {
